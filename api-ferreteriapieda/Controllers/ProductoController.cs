...
namespace api_ferreteriapieda.Controllers
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        {
            csProductoInsertar obj = new csProductoInsertar();
        ...
        {
            csProductoActualizar obj = new csProductoActualizar();
        ...
        {
            csProductoEliminar obj = new csProductoEliminar();
        ...
        {
            csProductoListar obj = new csProductoListar();
